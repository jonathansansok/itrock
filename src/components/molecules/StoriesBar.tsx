...
export default function StoriesBar() {
  const demo: Story[] = DUM_USERS.slice(0, 20).map(u => ({ id: u.id, name: u.name, emoji: u.emoji }));
  ...
  return (
    <div className="relative mb-4 rounded-2xl border border-neutral-800/80 bg-black/60 p-3 sm:p-4 overflow-hidden">
      ...
      {/* Derecha (flecha hacia la derecha, corregida) */}
      <button
        type="button"
        ...
        className={[
          ...
          "bg-black/50 backdrop-blur flex items-center justify-center",
          "hover:bg-black/70 active:scale-95 transition",
          !canRight ? "opacity-30 cursor-default" : "opacity-100"
        ].join(" ")}
      >
