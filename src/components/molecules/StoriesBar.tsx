...
export default function StoriesBar() {
  ...
  return (
    <div className="relative mb-4 rounded-2xl bg-black/60 p-3 sm:p-4 overflow-hidden">
      {(canLeft || canRight) && (
        <>
      ...
      {canLeft && (
        <button
          ...
          className="absolute left-1 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-black/50 backdrop-blur flex items-center justify-center hover:bg-black/70 active:scale-95 transition"
        >
      ...
      {canRight && (
        <button
          ...
          className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-black/50 backdrop-blur flex items-center justify-center hover:bg-black/70 active:scale-95 transition"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" className="text-neutral-200">
