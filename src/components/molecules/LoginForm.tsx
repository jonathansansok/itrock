  ...
  return (
    <form onSubmit={submit} className="space-y-3" noValidate>
      ...
      {touched.email && !emailOk && (
        <TimedError text="Ingresá un email válido (ej. usuario@dominio.com)." ms={3000} onCloseAction={() => setTouched(t => ({ ...t, email: false }))} />
      )}
      ...
      {touched.password && !passOk && (
        <TimedError text="Mínimo 8 caracteres, con una mayúscula y un número." ms={3000} onCloseAction={() => setTouched(t => ({ ...t, password: false }))} />
      )}
